...
<html>
    <head>
        ...
        <script>
            function showUsers(){
                document.getElementById('form01').action="View_Car.php"
    ...
    <div class="box">
        ...
        <?php
            ...
            if ($results->num_rows > 0) {
                ...
                echo "<p align='center'>THERE ARE NO DATA OF THIS CAR</p>";
            }
        ?>
        <form action="delete_Car02.php" id="form01" method="post" align="center" class="mod_table">
            <p align="center">DELETE THE SELECTED CAR</p>
